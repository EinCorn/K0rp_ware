  ...
  return (
    <div
      ...
      style={{
        ...
        '--korp-module-underlay-left': `${metrics.apertureUnderlayRect.x}px`,
        '--korp-module-underlay-top': `${metrics.apertureUnderlayRect.y}px`,
        '--korp-module-underlay-width': `${metrics.apertureUnderlayRect.width}px`,
        '--korp-module-underlay-height': `${metrics.apertureUnderlayRect.height}px`,
